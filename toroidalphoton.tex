...
\begin{figure}[htb]\centering
  ...
  \label{fig:zpe}
\end{figure}
%TODO: update caption and main text to reflect new version of bottom panel
...
\end{figure}
% TODO: update caption and main text to reflect latest version
...
\begin{figure}[htb]
  \centering
  \includegraphics[width=0.9\linewidth]{exp_fig} % anc/scripts/experimental_fig.jl
