...
%TODO: add explanation of sqrt(β) scaling in both real and mom space, using formula for landau level energies and saying it's all kinetic energy
...
%TODO: explain non-dissipative curve is not exactly like analytics: boundary effects
...
%TODO: momentum space cyclotron orbit
%TODO: elaborate on effect of larger γ when more peaks are excited
\begin{figure}[htb]
  \centering
...
%TODO: fix missing figure reference
...
%TODO: include fringe_trap.pdf
%TODO: include sym_ring.pdf
...
\begin{figure}[htb]\centering
  \includegraphics[width=0.9\linewidth]{nonabcorr}
  ...
  \label{fig:zpe}
% TODO: move to main text, update formulae and caption, update legend
\end{figure}

\begin{figure}[htb]
  \centering
  \includegraphics[width=0.9\linewidth]{sym_ring}
  \caption{}
  \label{fig:torus_edge}
% TODO: add caption, move to main text
\end{figure}

\begin{figure}[htb]
  \centering
  \includegraphics[width=0.9\linewidth]{fringe_trap}
  \caption{}
