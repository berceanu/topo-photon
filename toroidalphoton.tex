...
\begin{figure}[htb]
  \centerline{\includegraphics[width=0.7\linewidth]{bands}}
...
\begin{figure}[htb]
  \centerline{\includegraphics[width=0.7\linewidth]{zpe}}
...
\begin{figure}[htb]
  \centerline{\includegraphics[width=0.7\linewidth]{weak_trap}}
