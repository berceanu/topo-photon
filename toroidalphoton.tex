...
\begin{figure}[htb]
  \centerline{\includegraphics[width=0.7\linewidth]{pumps/pumps.png}}
...
\begin{figure}[htb]
  \centerline{\includegraphics[width=0.7\linewidth]{lobes/lobes.png}}
...
\begin{figure}[htb]
  \centerline{\includegraphics[width=0.7\linewidth]{circles/circles.png}}
...
\begin{figure}[htb]
  ...
  \caption{\emph{Position}: Intensity spectrum for a pump with Gaussian profile centered at (5,5), now using the symmetric gauge.}
...
also take a stronger trap and a smaller value of $\alpha$ to increase
the level spacing. We chose $\kappa = 0.2$ and $\alpha = 1/13$. We
work in the Landau gauge and pump the single site (3,3). 

\begin{figure}[htb]
  \centerline{\includegraphics[width=0.7\linewidth]{experiment/expspect.png}}
  \caption{Intensity spectrum for $N=11$ and $\gamma = 0.0505$. We filter at the energy of the third eigenstate, $\beta=2$.}
  \label{fig:exp_spectrum}
\end{figure}


\begin{figure}[htb]
  \centerline{\includegraphics[width=0.7\linewidth]{experiment/experiment.png}}
  \caption{\emph{Bottom row}: emission from the state at $\omega_0 =
-2.63$ in real (left column), momentum-space (middle column) and MBZ
(right column). The $\delta$-like pump at (3,3) is visible as a white
dot.
 \emph{Top row}: emission at the same energy, but with no pumping or
decay.}
...
\begin{figure}[htb]
  \centerline{\includegraphics[width=0.7\linewidth]{experiment/expcomp.png}}
  \caption{\emph{Position}: Slice along the $p_x^0 = 0$ line in the MBZ (black) compared to the analytical prediction (red). }
  \label{fig:exp_analytics}
\end{figure}
